...
**วันที่:** 2026-07-17
**สถานะ:** Draft v2 — รีวิวโดย Codex แล้ว, แก้ตามข้อเสนอ 6/7 ข้อ, เหลือ 1 ข้อ (ตัวเลข reward ที่แท้จริงเมื่อคิดรวมทั้งสัปดาห์) รอ user ตัดสินใจ
...
>
> **ตัวเลือกที่เสนอ (รอ user ตัดสินใจ):**
> 1. คงเดิมทั้งหมด (19.3% rebate + EXP boost 50% ยังถือว่ารับได้ ไม่กระทบ pack economy ที่ tune ไว้มากนัก)
> 2. ลด `daily_open_pack` เหลือ 25 silver + 5 EXP (จาก 40+10) → rebate เหลือ ~14.2%, EXP boost เหลือ ~27.5%
> 3. ลดทั้ง `daily_open_pack` และ `weekly_open_pack10` ลงครึ่งหนึ่ง → rebate ~9.9%, EXP boost ~25%
>
> ตัวเลขในเอกสารส่วนที่เหลือยังอ้างอิงค่าเดิม (40+10 / 300+30) รอ user ยืนยันก่อนว่าจะใช้ตัวเลือกไหน
